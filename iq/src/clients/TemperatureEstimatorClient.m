%TemperatureEstimatorClient Accesses modeled temperatures on IQ devices
%
% Example:
...
% Name: TemperatureEstimatorClient.m
% Last update: 3/20/2019 by Matthew Piccoli
% Author: Matthew Piccoli
% Contributors: Raphael Van Hoffelen

classdef TemperatureEstimatorClient < Client
    ...
    methods
        ...
        function obj = TemperatureEstimatorClient(varargin)
            args = varargin;
            args = [args, {'filename', 'temperature_estimator.json'}];
            obj@Client(args{:});
        end
