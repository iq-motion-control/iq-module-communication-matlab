%HobbyInputClient Changes hobby input parameters
%
% Example:
...
% Name: HobbyInputClient.m
% Last update: 3/20/2019 by Matthew Piccoli
% Author: Matthew Piccoli
% Contributors: Raphael Van Hoffelen

classdef HobbyInputClient < Client
    ...
    methods
        ...
        function obj = HobbyInputClient(varargin)
            args = varargin;
            args = [args, {'filename', 'hobby_input.json'}];
            obj@Client(args{:});
        end
