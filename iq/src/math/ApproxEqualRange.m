%ApproxEqualRange Determines if two numbers are within a range
%   ApproxEqualRange( a, b, range ) Determines if a and b are within
...
% Name: ApproxEqualRange.m
% Last update: 3/20/2019 by Matthew Piccoli
% Author: Matthew Piccoli
% Contributors: Raphael Van Hoffelen

function [ out ] = ApproxEqualRange( a, b, range )
    out = (a + abs(range)) >= b && (a - abs(range)) <= b;
end
